...
public class TaskTest {
    ...
    public void start() {
        ...
        builder5.add(TASK_60);
        builder5.add(TASK_61).dependOn(TASK_60);
        builder5.add(TASK_62).dependOn(TASK_60);
        builder5.add(TASK_63).dependOn(TASK_62);
        ...
        Project project8 = builder5.build();
        ...
        Project project9 = builder5.build();

        Task taskA = new TestTaskFactory.TASK_A();
        ...
        RiverManager.getInstance()
//                .applicationBlockUntilTaskFinish(TASK_7)
                .start(taskA);
    }
}
